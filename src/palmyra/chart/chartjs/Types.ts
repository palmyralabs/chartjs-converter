...
interface ChartJsData<TType extends ChartType = ChartType,
    TData = DefaultDataPoint<TType> & { key?: any }, TLabel = string> extends ChartData<TType, TData,
        TLabel> {
    keys?: any[]
}

type ChartJsDataSet<TType extends ChartType = ChartType,
    TData = DefaultDataPoint<TType>> = ChartDataset<TType, TData> & { key?: any };
